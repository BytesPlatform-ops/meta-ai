...
_TOOL_TTL = {
    "saas_account_overview": 120,
    "saas_list_campaigns": 90,
    "saas_campaign_detail": 120,
    "saas_time_series_insights": 120,
    "saas_page_posts": 180,
    "get_deep_ad_insights": 120,
...
class MCPClient:
    ...
    async def list_campaigns(
        ...
        return await self.call_tool(
            "saas_list_campaigns",
            {"ad_account_id": ad_account_id, "status_filter": status_filter, "limit": limit},
            user_access_token,
        )
    ...
    async def get_campaign_insights(
        ...
        return await self.call_tool(
            "saas_campaign_insights",
            {"campaign_id": campaign_id, "date_preset": date_preset},
            user_access_token,
        )
    ...
    async def list_ads(
        ...
        return await self.call_tool(
            "saas_list_ads",
            {"campaign_id": campaign_id, "date_preset": date_preset, "status_filter": status_filter},
            user_access_token,
        )
