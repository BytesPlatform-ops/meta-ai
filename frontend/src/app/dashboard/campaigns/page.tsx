    ...
    <div className="flex items-center gap-4 px-5 py-3 bg-white/[0.01] hover:bg-white/[0.03] transition-all border-b border-white/[0.04] last:border-b-0">
      ...
      <div className="hidden md:flex items-center gap-6 text-xs text-gray-400">
        ...
        <div className="text-center w-16">
          <p className="text-gray-600">{ad.result_type === "leads" ? "CPL" : "ROAS"}</p>
          <p className="text-white font-medium">
            {ad.result_type === "leads"
        ...
        <div className="text-center w-16">
          <p className="text-gray-600">{ad.result_type === "leads" ? "Leads" : "Purchases"}</p>
    ...
    <div className="glass rounded-2xl overflow-hidden hover:bg-white/[0.02] transition-all duration-300">
      ...
      >
        ...
        <div className="hidden lg:flex items-center gap-6 text-xs text-gray-400 shrink-0">
          ...
          <div className="text-center w-16">
            <p className="text-gray-600">{campaign.result_type_7d === "leads" ? "CPL" : "ROAS"}</p>
            {campaign.result_type_7d === "leads" ? (
          ...
          <div className="text-center w-16">
            <p className="text-gray-600">{campaign.result_type_7d === "leads" ? "Leads" : "Purchases"}</p>
    ...
    <div className="p-8 w-full animate-fade-in">
      ...
      {overview && (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          ...
          />
          {overview.result_type_30d === "leads" ? (
            <MetricCard
              label="CPL (30d)"
          ...
          <MetricCard
            label={`${overview.result_type_30d === "leads" ? "Leads" : "Purchases"} (30d)`}
